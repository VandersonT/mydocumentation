    ...
    return (
        <>
            <section className={style.mainTitle}>
                <Link href="/Panel/docs"><i className="fa-solid fa-rotate-left"></i></Link>
                <h1>Doc Name <i className={`fa-solid fa-pen-to-square ${style.editIcon}`}></i></h1>
                <button className={style.save}>Create</button>
            </section>
